...
/**
 * Adds a new members to the type.
 *
 * @method addMembers
 * @param {Array} members Members instances to add to type.
 */
Type.prototype.addMembers = function(members) {
 ...
 */
Type.prototype.removePrivates = function() {
